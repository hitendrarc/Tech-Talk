				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="home" method="post" class="login-form">
												...
												<tr>
													...
													<td><input type="hidden" name="field1"
														...
														<button type="submit" class="btn"
															value="${item.getTitle()}" name="register"
															onclick="myFunction()">Register!</button></td>
												</tr>
											</c:forEach>
								...
								<button type="submit" class="btn" value="logout" name="logout">Logout!</button>
							</form>
						</div>
					</div>
				</div>
